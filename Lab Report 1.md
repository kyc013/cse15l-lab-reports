...
`When **cd** is commanded with a path to a file, an error messgae is printed saying that it is not a directory. As we can see, this command can only be used for directories.`
***
## ls
