...
I can't say for the rest of the students taking this class, but I didn't know how to do any of these things before. Learning commands such as pwd, cat, cd, ls, curl etc was fun, as was accessing remote servers from a local computer. One thing I didn't initially recognize its importance was the working directory. As I participated in the labs, however, I found myself making mistakes because I was in the wrong directory without realizing it. For instance, I'd try to compile my java file inside the folder when stil being in the home directory. A basic concept, but I think it'll still be crucial for whatever stage I'm in.
